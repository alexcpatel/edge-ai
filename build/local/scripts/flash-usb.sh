...
log_info "   - Power off the device completely"
log_info "   - Locate the RECOVERY button on the board"
log_info "   - Press and HOLD the RECOVERY button"
log_info "   - While holding RECOVERY, press and release the POWER button"
log_info "   - Continue holding RECOVERY for 2-3 seconds"
log_info "   - Release the RECOVERY button"
log_info ""
log_step "3. Verify the device is in recovery mode:"
log_info "   - The device should appear as 'NVIDIA Corp. APX' in system information"
log_info "   - You can verify by running: system_profiler SPUSBDataType | grep -i nvidia"
log_info ""
...
log_info ""
log_step "3. Remove any recovery mode jumpers or connections"
log_info "   - If you shorted pins for recovery mode, remove the jumper"
log_info ""
